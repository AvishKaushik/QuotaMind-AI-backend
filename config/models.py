...
COST_PER_1K_TOKENS: dict[str, dict[str, float]] = {
    ...
    "gemini-2.5-flash-lite": {"input": 0.00004,  "output": 0.00015},
}
...
# Critical floors at tier 2 (not 3): the demo's free-tier Gemini key has zero
# 2.5-pro quota, so a tier-3 floor would make every critical request fail.
